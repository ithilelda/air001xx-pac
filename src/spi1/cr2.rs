...
pub type SlvfmR = crate::BitReader;
#[doc = "Field `SLVFM` writer - Slave fast mode enable"]
pub type SlvfmW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn slvfm(&self) -> SlvfmR {
        SlvfmR::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Rx buffer DMA enable"]
    #[inline(always)]
    pub fn rxdmaen(&mut self) -> RxdmaenW<'_, Cr2Spec> {
        RxdmaenW::new(self, 0)
    }
    #[doc = "Bit 1 - Tx buffer DMA enable"]
    #[inline(always)]
    pub fn txdmaen(&mut self) -> TxdmaenW<'_, Cr2Spec> {
        TxdmaenW::new(self, 1)
    }
    #[doc = "Bit 2 - SS output enable"]
    #[inline(always)]
    pub fn ssoe(&mut self) -> SsoeW<'_, Cr2Spec> {
        SsoeW::new(self, 2)
    }
    #[doc = "Bit 5 - Error interrupt enable"]
    #[inline(always)]
    pub fn errie(&mut self) -> ErrieW<'_, Cr2Spec> {
        ErrieW::new(self, 5)
    }
    #[doc = "Bit 6 - RX buffer not empty interrupt enable"]
    #[inline(always)]
    pub fn rxneie(&mut self) -> RxneieW<'_, Cr2Spec> {
        RxneieW::new(self, 6)
    }
    #[doc = "Bit 7 - Tx buffer empty interrupt enable"]
    #[inline(always)]
    pub fn txeie(&mut self) -> TxeieW<'_, Cr2Spec> {
        TxeieW::new(self, 7)
    }
    #[doc = "Bit 11 - Data length"]
    #[inline(always)]
    pub fn ds(&mut self) -> DsW<'_, Cr2Spec> {
        DsW::new(self, 11)
    }
    #[doc = "Bit 12 - FIFO reception threshold"]
    #[inline(always)]
    pub fn frxth(&mut self) -> FrxthW<'_, Cr2Spec> {
        FrxthW::new(self, 12)
    }
    #[doc = "Bit 13 - Last DAM Transmit(RX)"]
    #[inline(always)]
    pub fn ldma_rx(&mut self) -> LdmaRxW<'_, Cr2Spec> {
        LdmaRxW::new(self, 13)
    }
    #[doc = "Bit 14 - Last DAM Transmit(TX)"]
    #[inline(always)]
    pub fn ldma_tx(&mut self) -> LdmaTxW<'_, Cr2Spec> {
        LdmaTxW::new(self, 14)
    }
    #[doc = "Bit 15 - Slave fast mode enable"]
    #[inline(always)]
    pub fn slvfm(&mut self) -> SlvfmW<'_, Cr2Spec> {
        SlvfmW::new(self, 15)
    }
}

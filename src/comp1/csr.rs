...
pub type ScalerEnR = crate::BitReader;
#[doc = "Field `SCALER_EN` writer - SCALER enable bit"]
pub type ScalerEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn scaler_en(&self) -> ScalerEnR {
        ScalerEnR::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - SCALER enable bit"]
    #[inline(always)]
    pub fn scaler_en(&mut self) -> ScalerEnW<'_, CsrSpec> {
        ScalerEnW::new(self, 1)
    }
    #[doc = "Bits 4:7 - Comparator signal selector for inverting input INM"]
    #[inline(always)]

...
#[doc = "Field `ICPSC` reader - Input capture 1 prescaler"]
pub type IcpscR = crate::FieldReader;
#[doc = "Field `ICPSC` writer - Input capture 1 prescaler"]
pub type IcpscW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    #[inline(always)]
    pub fn icpsc(&self) -> IcpscR {
        IcpscR::new(((self.bits >> 2) & 3) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 2:3 - Input capture 1 prescaler"]
    #[inline(always)]
    pub fn icpsc(&mut self) -> IcpscW<'_, Ccmr1InputSpec> {
        IcpscW::new(self, 2)
    }
    #[doc = "Bits 4:7 - Input capture 1 filter"]
    #[inline(always)]
    ...
    #[doc = "Bits 10:11 - Input capture 2 prescaler"]
    #[inline(always)]
    pub fn ic2psc(&mut self) -> Ic2pscW<'_, Ccmr1InputSpec> {
        Ic2pscW::new(self, 10)
    }
    #[doc = "Bits 12:15 - Input capture 2 filter"]
    #[inline(always)]
